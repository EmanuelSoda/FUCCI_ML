...
setwd("~/Documents/IEO/FUCCI_cell_Tracking/")
```
...
path <- "data/230421_Thunder_hsb_nb4_q03/"
filelist <- 
...
```{r,echo=FALSE}
reactable(
 mutate(data_table, across(where(is.numeric), round, 3)),
...
```{r,echo=FALSE}
reactable(
 mutate(tsfeature_tbl, across(where(is.numeric), round, 3)),
  defaultColDef = colDef(
    align = "center",
    minWidth = 70,
    headerStyle = list(background = "#f7f7f8")
...
```{r,echo=FALSE}
reactable(
 mutate(data_table_good, across(where(is.numeric), round, 3)),
  defaultColDef = colDef(
    align = "center",
    minWidth = 70,
    headerStyle = list(background = "#f7f7f8")
...
```{r,echo=FALSE}
reactable(
 mutate(split_cell_cycle_splitted, across(where(is.numeric), round, 3)),
  defaultColDef = colDef(
    align = "center",
    minWidth = 70,
    headerStyle = list(background = "#f7f7f8")
...
write_rds(NB4_22_04_22,file = "NB4_22_04_22_new_model.rds")
```
